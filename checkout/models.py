...
class Order(models.Model):
    ...
    def update_total(self):
        ...
        self.grand_total = self.lineitems.aggregate(Sum('lineitem_disc_total'))['lineitem_disc_total__sum'] or 0
        self.discount = self.order_total - self.grand_total
        self.save()
...
class OrderLineItem(models.Model):
    ...
    tour_date = models.CharField(max_length=40, null=False,
                                 blank=False, default='')
    discount = models.DecimalField(max_digits=6, decimal_places=2,
                                   null=False, default=0)
    lineitem_total = models.DecimalField(max_digits=6, decimal_places=2,
                                         ...
                                         editable=False)
    lineitem_disc_total = models.DecimalField(max_digits=6, decimal_places=2,
                                              null=False, blank=False,
